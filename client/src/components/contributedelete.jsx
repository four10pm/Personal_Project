...
function DeleteDateListForm({ allDates, message, setMessage }) {
    ...
    return (
        <form name="deleteDateList" className="contributeform deleteForm" onSubmit={deleteDateList}>
...
function DeleteDateExampleForm({ dateExamples, message, setMessage }) {
    ...
    return (
        <form name="deleteDateExample" className="contributeform deleteForm" onSubmit={(event) => { deleteDateExample(event) }}>
            <label> Which date would you like to delete?  &nbsp;
...
function DeleteCityForm({ cities, message, setMessage }) {
    ...
    return (
        <form name="deleteCity" className="contributeform deleteForm" onSubmit={(event) => { deleteCity(event) }}>
            <label> Which city would you like to delete? &nbsp;
