  ...
  return (
    ...
    <Fetching setCities={setCities} cities={setCities} dateTypes={dateTypes} setDateTypes={setDateTypes} allDates={allDates} setAllDates={setAllDates} dateExamples={dateExamples} setDateExamples={setDateExamples} selectedDate={selectedDate} setSelectedDat={setSelectedDate} />
      ...
      <div className="App" myName={myName}>
          ...
          <Routes> 
            <Route path="/" 
            element={<DateList allDates={allDates} setAlLDates={setAllDates} selectedDate={selectedDate} setSelectedDate={setSelectedDate} dateExamples={dateExamples} setDateExamples={setDateExamples} token={token} dateTypes={dateTypes} cities={cities} favorites={favorites} setFavorites={setFavorites} user={user} /> } 
            />
            <Route path="/cities" element={<Cities token={token} cities={cities} dateTypes={dateTypes} />} /> 
            <Route path ="/account" element={<Account token={token} setToken={setToken} cities={cities} favorites={favorites} setFavorites={setFavorites} user={user} setUser={setUser}/>}/>
